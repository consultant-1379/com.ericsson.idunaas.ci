...
pipeline {
    ...
    stages {
        ...
        //             sh "${bob} create-eiap-user:execute-script-appmgr"
        //         }
        //     }
        // }
        // stage('Create EIAP BNEW User'){
        //     when{
        //         expression{
        //             params.ENV_NAME.contains('bnew')
        //         }
        //     }
        //     steps{
        //         withCredentials([usernamePassword(credentialsId: params.IDUN_USER_SECRET, usernameVariable: 'IDUN_USER_USERNAME', passwordVariable: 'IDUN_USER_PASSWORD')]) {
        //             sh "${bob} create-eiap-user:execute-script-bnew"
        //         }
        //     }
        // }
    }
