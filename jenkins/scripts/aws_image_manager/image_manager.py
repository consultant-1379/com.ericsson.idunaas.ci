...
def __get_images(args, skip_scalar=False):
    ...
    image_list.add(Image(repo="armdocker.rnd.ericsson.se/proj-eric-oss-drop/eric-oss-deployment-manager", tag="latest"))
    image_list.add(Image(repo="armdocker.rnd.ericsson.se/proj-idun-aas/ci-utils", tag="latest"))
    return image_list
