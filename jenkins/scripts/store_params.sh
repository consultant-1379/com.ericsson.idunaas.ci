...
IAM_HOSTNAME=${22}
GAS_HOSTNAME=${23}
PROMETHEUS_HOSTNAME=${24}
DASHBOARD_HOSTNAME=${25}
CFG_PATH=${26}
WORKDIR=${27}
ADC_HOSTNAME=${28}
APPMGR_HOSTNAME=${29}
OS_HOSTNAME=${30}
DISABLEPUBLICACCESS=${31}
...
PROMETHEUS_HOSTNAME=$(param_value "Hostnames.prometheus" "$PROMETHEUS_HOSTNAME")
DASHBOARD_HOSTNAME=$(param_value "Hostnames.dashboard" "$DASHBOARD_HOSTNAME")
